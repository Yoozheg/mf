(function(document, $, undefined){
 ...
 $.splash = (function(){
  ...
  $.css('.splash', 'position:fixed;top:0;right:0;bottom:0');
	...
	$.css('#splash>aside.splash' , 'width:13%;background:top right url(/xjsl/plugins/splash/images/close.png) no-repeat;border:none;color:transparent;text-align:right;padding-right:45px;padding-top:10px;font-size:16px;cursor:pointer;transition:0.7s all');
